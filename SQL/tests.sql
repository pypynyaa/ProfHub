...
(2, 'Оценка простых сенсомоторных реакций человека', 'реакция на звук', 'tests/sound_reaction_test_interface.php'),
...
UPDATE `tests` SET `file_path` = 'tests/sound_reaction_test_interface.php' WHERE `id` = 2;
